...
const translations: Translations = {
  ...
  services: { 中文: '各种服务', 한국어: '서비스', English: 'Services' },
  forum: { 中文: '探吧', 한국어: '탐바', English: 'Explore' },
  ...
  variousServices: { 中文: '各种服务', 한국어: '서비스', English: 'Services' },
  exploreBar: { 中文: '探吧', 한국어: '탐바', English: 'Explore' },
