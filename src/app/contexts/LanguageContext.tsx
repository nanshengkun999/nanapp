...
const translations: Translations = {
  ...
  services: { 中文: '本地搭子', 한국어: '로컬 메이트', English: 'Local mate' },
  forum: { 中文: '小圈子', 한국어: '작은 모임', English: 'Circle' },
  more: { 中文: '更多', 한국어: '더보기', English: 'More' },
  video: { 中文: '视频', 한국어: '영상', English: 'Video' },
  search: { 中文: '搜索', 한국어: '검색', English: 'Search' },
  homeMy: { 中文: '我的', 한국어: '내 정보', English: 'Me' },
  variousServices: { 中文: '本地搭子', 한국어: '로컬 메이트', English: 'Local mate' },
  exploreBar: { 中文: '小圈子', 한국어: '작은 모임', English: 'Circle' },
  favoritesFolder: { 中文: '收藏夹', 한국어: '저장함', English: 'Saved' },
  previousCategory: { 中文: '上一个分类', 한국어: '이전 분류', English: 'Previous category' },
  nextCategory: { 中文: '下一个分类', 한국어: '다음 분류', English: 'Next category' },
  setHomeCategory: { 中文: '设为主页分类', 한국어: '홈 분류로 설정', English: 'Set as home category' },
  approxSevenMinuteWalk: { 中文: '步行7分钟', 한국어: '도보 7분', English: '7 min walk' },
  muteVideo: { 中文: '静音视频', 한국어: '영상 음소거', English: 'Mute video' },
  unmuteVideo: { 中文: '打开声音', 한국어: '소리 켜기', English: 'Unmute video' },
  playVideo: { 中文: '播放视频', 한국어: '영상 재생', English: 'Play video' },
  videoProgress: { 中文: '视频进度', 한국어: '영상 진행률', English: 'Video progress' },
  ...
  servicesTitle: { 中文: 'Tanmap 各种服务', 한국어: 'Tanmap 서비스', English: 'Tanmap Services' },
